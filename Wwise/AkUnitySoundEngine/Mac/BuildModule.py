...
def CreatePlatformBuilder(platformName, arches, configs, generateSwig, skipPremake, isMultiSDK):
	return MacBuilder(platformName, arches, configs, generateSwig, skipPremake)

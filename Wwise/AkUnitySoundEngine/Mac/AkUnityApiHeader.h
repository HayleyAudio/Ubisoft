...
#error AkSoundEngine.h: Undefined platform
	...
	/// \sa 
	/// - AkInitSettings
	typedef   void( __cdecl * AkAssertHook)( 
...
typedef  void( __cdecl * AkJobWorkerFunc)(
...
struct AkJobMgrSettings
{
	...
	typedef  void( __cdecl * FuncRequestJobWorker)(
...
typedef  void( __cdecl * AkProfilerPushTimerFunc)(
...
typedef  void( __cdecl * AkProfilerPopTimerFunc)();
...
typedef  void( __cdecl * AkProfilerPostMarkerFunc)(
	AkPluginID in_uPluginID,
...
/// - \ref soundengine_markers
/// - \ref soundengine_music_callbacks
typedef   void( __cdecl * AkCallbackFunc )( 
...
/// - AK::SoundEngine::RegisterBusVolumeCallback()
/// - \ref goingfurther_speakermatrixcallback
typedef   void( __cdecl * AkBusCallbackFunc )( 
...
/// - \ref goingfurther_speakermatrixcallback
typedef   void( __cdecl * AkBusMeteringCallbackFunc )( 
...
/// - \ref goingfurther_speakermatrixcallback
typedef   void( __cdecl * AkOutputDeviceMeteringCallbackFunc )(
...
/// - \ref soundengine_banks
typedef   void( __cdecl * AkBankCallbackFunc )(
	AkUInt32		in_bankID,
...
typedef   void( __cdecl * AkGlobalCallbackFunc )(
...
typedef   void( __cdecl * AkResourceMonitorCallbackFunc )(
...
namespace AK
{
	...
	/// \sa AK::SoundEngine::AddOutput
	typedef  void( __cdecl * AkDeviceStatusCallbackFunc)(
		AK::IAkGlobalPluginContext * in_pContext,	///< Engine context.
...
typedef  void( __cdecl * AkCaptureCallbackFunc)(
...
namespace AK
{
	...
	namespace Monitor
	{
		...
		typedef   void( __cdecl * LocalOutputFunc )(
...
typedef   bool( __cdecl * AkCandidateCallbackFunc )(
